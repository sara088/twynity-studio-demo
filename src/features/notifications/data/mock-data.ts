...
export const NOTIFICATIONS: Notification[] = [
  {
    ...
    body: "Virtual Sara's video avatar finished processing — start a face-to-face conversation in the studio.",
    time: "Just now",
    read: false,
  },
  {
    ...
    icon: Sparkles,
    tone: "violet",
    title: "Virtual Sara is live in your studio",
  ...
  },
  {
    ...
    body: "Virtual Sara can now read, draft, and triage email on your behalf.",
    time: "2h ago",
    read: false,
  },
  {
